<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="执行单位" prop="executeUnit">
        <el-input
          v-model="queryParams.executeUnit"
          placeholder="请输入执行单位"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="前置任务编号" prop="prerequisiteTaskId">
        <el-input
          v-model="queryParams.prerequisiteTaskId"
          placeholder="请输入前置任务编号"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="taskList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="执行单位" align="center" prop="executeUnit" />
      ...
      <el-table-column label="前置任务编号" align="center" prop="prerequisiteTaskId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="执行单位" prop="executeUnit">
          <el-input v-model="form.executeUnit" placeholder="请输入执行单位" />
        </el-form-item>
        <el-form-item label="开始时间" prop="startDate">
          <el-date-picker clearable
        ...
        <el-form-item label="前置任务编号" prop="prerequisiteTaskId">
          <el-input v-model="form.prerequisiteTaskId" placeholder="请输入前置任务编号" />
        </el-form-item>
      </el-form>
